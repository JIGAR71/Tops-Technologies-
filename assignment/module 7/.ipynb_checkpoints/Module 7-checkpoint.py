...
"""
Applications are everywhere – some run on our phones, some on computers,
and some silently in the background. These include:
- Web apps (like Gmail, YouTube)
- Desktop apps (like MS Word, Excel)
- Mobile apps (like WhatsApp, Instagram)
- Games (like PUBG, Candy Crush)
- AI/ML apps (like ChatGPT )
Python helps build all of these. and truly a versatile and powerful language.
"""
